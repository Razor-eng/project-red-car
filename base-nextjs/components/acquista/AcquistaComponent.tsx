...
import AutoSimiliCard from "../detagli/AutoSimiliCard";
      ...
      <div className="w-full">
        ...
        <div className="w-full flex flex-col lg:flex-row items-center lg:justify-between">
          <div className="w-full flex flex-col items-center lg:items-start">
            <h2 className="text-[32px] font-bold">Acquista</h2>
...
export default AcquistaComponent;
