...
export default async function NoleggiaPage({
  searchParams = {},
}: {
  ...
  const [vehicleResponse, filterResponse] = await Promise.all([
    getVehicles({ ...filters, page, pageSize, order, typeSearch: "noleggio" }),
    getFilters({ ...filters, typeSearch: "noleggio" }),
  ]);
  ...
  return (
    <>
      <div className="products-page-wrapper w-full">
        ...
        >
          <FilterMenuMobile>
            <FilterMenu pageFrom={"noleggio-b2b"} {...filterMenuProps} />
          </FilterMenuMobile>
        </Suspense>
            ...
            <div className="flex-1 py-4">
              <div className="flex max-lg:flex-col max-lg:w-full justify-between py-5">
                ...
                <div className="selectOrder max-lg:flex-row-reverse max-lg:w-full flex flex-col justify-between">
                  <SelectOrder initialOrder={order || "prezzo_DESC"} />
              ...
              >
                <InfiniteScroll
                  ...
                  pageSize={pageSize}
                  ItemComponent={ProductCartNoleggio} // Usa ProductCard
                  typeSearch={"noleggio"}
                />
              </Suspense>
            </div>
